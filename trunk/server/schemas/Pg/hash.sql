...
CREATE INDEX idx_feed_hash_md5 ON hash_md5 (detecttime DESC, severity DESC, confidence DESC);
...
CREATE INDEX idx_feed_hash_sha1 ON hash_sha1 (detecttime DESC, severity DESC, confidence DESC);
