...
CREATE INDEX idx_feed_email_search ON email_search (address, detecttime DESC, severity DESC, confidence DESC);
...
CREATE INDEX idx_feed_email_phishing ON email_phishing (address, detecttime DESC, severity DESC, confidence DESC);
...
CREATE INDEX idx_feed_email_registrant ON email_registrant (address, detecttime DESC, severity DESC, confidence DESC);
