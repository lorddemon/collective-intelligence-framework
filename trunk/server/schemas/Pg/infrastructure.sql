...
CREATE INDEX idx_feed_infrastructure_botnet ON infrastructure_botnet (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_malware ON infrastructure_malware (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_whitelist ON infrastructure_whitelist (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_scan ON infrastructure_scan (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_spam ON infrastructure_spam (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_network ON infrastructure_network (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_suspicious ON infrastructure_suspicious (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_phishing ON infrastructure_phishing (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_search ON infrastructure_search (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_infrastructure_passivedns ON infrastructure_passivedns (detecttime,severity,confidence);
