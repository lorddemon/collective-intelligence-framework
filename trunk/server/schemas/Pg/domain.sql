...
CREATE INDEX idx_feed_domain_whitelist ON domain_whitelist (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_fastflux ON domain_nameserver (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_nameserver ON domain_nameserver (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_malware ON domain_malware (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_botnet ON domain_botnet (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_passivedns ON domain_passivedns (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_search ON domain_search (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_phishing ON domain_phishing (detecttime,severity,confidence);
...
CREATE INDEX idx_feed_domain_suspicious ON domain_suspicious (detecttime,severity,confidence);
