...
ALTER TABLE feed_infrastructure ADD CONSTRAINT feed_infrastructure_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_botnet ADD CONSTRAINT feed_infrastructure_botnet_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_malware ADD CONSTRAINT feed_infrastructure_malware_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_network ADD CONSTRAINT feed_infrastructure_network_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_phishing ADD CONSTRAINT feed_infrastructure_phishing_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_spam ADD CONSTRAINT feed_infrastructure_spam_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_scan ADD CONSTRAINT feed_infrastructure_scan_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_suspicious ADD CONSTRAINT feed_infrastructure_suspicious_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_asn ADD CONSTRAINT feed_infrastructure_asn_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_whitelist ADD CONSTRAINT feed_infrastructure_whitelist_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_infrastructure_search ADD CONSTRAINT feed_infrastructure_search_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_domain ADD CONSTRAINT feed_domain_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_domain_botnet ADD CONSTRAINT feed_domain_botnet_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_domain_malware ADD CONSTRAINT feed_domain_malware_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_domain_nameserver ADD CONSTRAINT feed_domain_nameserver_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_domain_fastflux ADD CONSTRAINT feed_domain_fastflux_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_domain_whitelist ADD CONSTRAINT feed_domain_whitelist_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_url ADD CONSTRAINT feed_url_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_url_malware ADD CONSTRAINT feed_url_malware_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_url_botnet ADD CONSTRAINT feed_url_botnet_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_url_phishing ADD CONSTRAINT feed_url_phishing_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
...
ALTER TABLE feed_malware ADD CONSTRAINT feed_malware_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
ALTER TABLE feed_malware ADD UNIQUE(uuid);

CREATE TABLE feed_email () INHERITS (feed);
ALTER TABLE feed_email ADD PRIMARY KEY (id);
ALTER TABLE feed_email ADD CONSTRAINT feed_email_uuid_fkey FOREIGN KEY (uuid) REFERENCES archive(uuid) ON DELETE CASCADE;
