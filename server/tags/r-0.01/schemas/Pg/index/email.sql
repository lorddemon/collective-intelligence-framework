...
DROP INDEX IF EXISTS idx_created_email_search;
...
CREATE INDEX idx_created_email_search ON email_search (created);

DROP INDEX IF EXISTS idx_feed_email_phishing;
DROP INDEX IF EXISTS idx_query_email_phishing;
DROP INDEX IF EXISTS idx_created_email_phishing;
...
CREATE INDEX idx_created_email_phishing ON email_phishing (created);

DROP INDEX IF EXISTS idx_feed_email_registrant;
DROP INDEX IF EXISTS idx_query_email_registrant;
DROP INDEX IF EXISTS idx_created_email_registrant;
...
CREATE INDEX idx_created_email_registrant ON email_registrant (created);
