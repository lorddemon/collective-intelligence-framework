...
DROP INDEX IF EXISTS idx_created_hash_md5;
...
CREATE INDEX idx_created_hash_md5 ON hash_md5 (created);

DROP INDEX IF EXISTS idx_feed_hash_sha1;
DROP INDEX IF EXISTS idx_query_hash_sha1;
DROP INDEX IF EXISTS idx_created_hash_sha1;
...
CREATE INDEX idx_created_hash_sha1 ON hash_sha1 (created);

DROP INDEX IF EXISTS idx_feed_hash_uuid;
DROP INDEX IF EXISTS idx_query_hash_uuid;
DROP INDEX IF EXISTS idx_created_hash_uuid;
...
CREATE INDEX idx_created_hash_uuid ON hash_uuid (created);
